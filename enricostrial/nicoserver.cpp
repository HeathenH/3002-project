                ...
                for (auto& sublist : timetable) {
                    ...
                    if (time_in_timetable_datetime >= start_time_datetime) {
                        ...
                        if (isValidRoute(next_station, destination, adjacent_stations)) {
                            ...
                            cout << "CURRENT DESTINATION!!!!!!!!!!!!!!!!!!!!" << current_destination << endl;
                            ...
                            if (current_destination == destination) {
                                cout << "[DEBUG] Destination " << destination << " reached" << endl;
                                    ...
                                    // cout << " ++++++++++++++++++++" << current_destination << "++++++++++++++++++++++++" << std::endl;
                ...
                if (received_journey[0].back() == "ended" || received_journey[0].back() == "midnight") {
                    ...
                    for (auto& sublist : timetable) {
                        ...
                        if (time_in_timetable_datetime >= latest_time_datetime) {
                            ...
                            cout << temp1 << "111111111111" << endl;
                            cout << temp2 << "22222222222222222" << endl;
                            trim(temp1);
                            trim(temp2);
                            ...
                            if (isValidRoute(temp1, temp2, adjacent_stations)) {
                                cout << "IIIIIIIIIIIIIIIIIIIIIIIIIIIIIII" << endl;
                                string trimmed_temp1 = temp1;
                                string trimmed_temp2 = temp2;

                                trim(trimmed_temp1);
                                trim(trimmed_temp2);
                                cout << trimmed_temp1 << "<---TT1" << endl;
                            cout << trimmed_temp2 << "<---TT2" << endl;
                                if (trimmed_temp1 == trimmed_temp2) {
                                    ...
                                    cout << endl;
                                    cout << "++++ THE JOURNEY " << journey_data << "++++" << endl;
                                    ...
                                    for (auto& port : station_list) {
                                        ...
                                        string trimmed_port = port[0];
                                        string trimmed_journey_back = journey.back().back();
                                        cout << "44444444444 " << trimmed_journey_back << " 4444444444" << endl;
